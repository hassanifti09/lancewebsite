  ...
  return (
    <div className="flex p-10 md:px-0  flex-col md:flex-row gap-10 md:gap-16 font-light tracking-tight leading-tight w-full items-center justify-center py-20">
      <div className="flex flex-col md:w-[25%] text-center">
        ...
        A growing team of 35+ experts including engineers, designers, and strategists dedicated to building digital products.</p>
        <h3 className="text-7xl font-medium text-black">35</h3>
      </div>
      <div className="flex flex-col md:w-[25%] text-center">
        <p className="text-black/60 mb-4">
        Over 200 successful projects launched across diverse industries, each crafted with precision, and purpose.</p>
