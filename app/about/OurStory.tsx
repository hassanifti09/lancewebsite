...
const OurStory = () => {
  return (
    <div className=" pb-5 px-5">
      ...
      <br></br><br></br>
      As our expertise deepened and our horizons expanded, we set our sights on new frontiers. Today, Lance Systems is proud to extend its presence into the United States, bringing our distinctive blend of technical excellence, strategic insight, and relentless commitment to client success to one of the world’s most competitive markets. Yet, our core philosophy remains unchanged: the best technology is not just cutting-edge — it’s accessible, efficient, and built around the people who use it.
      <br></br><br></br>
