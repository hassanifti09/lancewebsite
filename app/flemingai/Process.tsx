        ...
        <div className="w-full flex flex-col gap-10 p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">01</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">02</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">03</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">04</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">05</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="text-6xl font-light text-blue-500">06</div>
